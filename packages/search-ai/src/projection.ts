import type { BlockRegistry, DisNoteBlock, DisNoteDocument, DisNoteInline } from "@disnote/document-core";
import { extractDocumentPlainText, extractHeadings, visitBlocks } from "@disnote/document-core";
